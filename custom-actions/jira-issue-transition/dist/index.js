...
var form_data = __nccwpck_require__(8890);
...
var proxy_from_env = __nccwpck_require__(7588);
...
var follow_redirects = __nccwpck_require__(5263);
...
var base64 = __nccwpck_require__(5217);
...
const index_URL = `${JIRA_REST_API_URL}/rest/api/3/issue/${JIRA_ISSUE_KEY}/transitions`;
...
async function transitionIssue(){     
    ...
    let response = await lib_axios(config); 
