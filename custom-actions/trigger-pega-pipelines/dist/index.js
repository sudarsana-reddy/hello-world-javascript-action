...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(3715))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(137);
...
var node_domexception = __nccwpck_require__(6678);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(2002);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require__(137);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(9249);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(137);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(2002);
...
var core = __nccwpck_require__(4824);
...
var esm_min = __nccwpck_require__(5161);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 901).then(__nccwpck_require__.bind(__nccwpck_require__, 2901));
...
var from = __nccwpck_require__(2353);
...
var lib = __nccwpck_require__(4780);
        ...
        for (let app of appListJson) {
            ...
            try {
                ...
                if( pipelineDetails.deploymentId === undefined){
                    pipelineDetails.deploymentId = "No Deployment Triggered";
...
async function generateDeolymentStatusJson(json){
    ...
    external_fs_.writeFileSync(PEGA_DEPLOYMENT_STATUS_JSON, JSON.stringify(json, null, 2), 'utf-8');
}
...
async function getAppListInfo() {
    const appListJsonString = external_fs_.readFileSync(`${process.cwd()}/${JIRA_PEGA_APP_DATA_JSON}`, 'utf-8');
    const appListJson = JSON.parse(appListJsonString);
    return appListJson;
}

async function getPipelinesInfo() {
    const PipelineInfoJsonString = external_fs_.readFileSync(`${process.cwd()}/${PEGA_PIPELINE_MAPPING_JSON}`, 'utf-8');
