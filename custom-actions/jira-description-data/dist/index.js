...
const index_URL = `${JIRA_REST_API_URL}/rest/api/3/issue/${JIRA_ISSUE_KEY}?fields=description,summary`;
...
async function generateAppListJson(json) {
    external_fs_.writeFileSync(JIRA_APP_JSON_FILE, JSON.stringify(json, null, 2), 'utf-8');
}
