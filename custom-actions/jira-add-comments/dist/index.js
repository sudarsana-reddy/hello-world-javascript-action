...
const index_URL = `${JIRA_REST_API_URL}/rest/api/3/issue/${JIRA_ISSUE_KEY}/comment`;
...
async function getPipelineStatusJsonData() {
    const PipelineInfoJsonString = external_fs_.readFileSync(`${process.cwd()}/${PEGA_DEPLOYMENT_STATUS_JSON}`, 'utf-8');
